package com.jzg.framework.utils.json;

import com.jzg.framework.utils.ConvertUtils;
import com.jzg.framework.utils.bean.BeanPropertyUtils;
...
public class JSONUtils {
	...
	public static String toJsonString(Object value){
		try {
			...
			if (value instanceof com.jzg.framework.utils.json.JSONString) {
	...
	private static Object populateBean(JSONObject jsonObj, Class clz){		
		...
		while(it.hasNext()){
			...
			Class type = BeanPropertyUtils.getPropertyType(clz, key);
	...
	private static Class[] getActualTypes(Class[] actualTypes, Class parentType, String propertyName){
		...
		return BeanPropertyUtils.getPropertyGenericActualTypes(parentType, propertyName);
	}
