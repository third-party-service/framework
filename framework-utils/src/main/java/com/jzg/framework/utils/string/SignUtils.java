...
public class SignUtils {
	...
	public static String buildRequestMysign(Map<String, String> sPara, String key) {
		String prestr = SignUtils.createLinkString(sPara); // 把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
		String mysign = "";
		if (SignUtils.sign_type.equals("MD5")) {
			mysign = SignUtils.sign(prestr, key, SignUtils.input_charset);
		}
		return mysign;
	}
