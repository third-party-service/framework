...
import com.jzg.framework.utils.ConvertUtils;
...
public class BeanUtils {
	...
	public static Object getProperty(Object obj, String property) {
		...
		try {
			while (st.hasMoreTokens()) {
				String currentPropertyName = st.nextToken();
				if (result != null) {
					result = BeanPropertyUtils.getProperty(result, currentPropertyName);
				}
			}
			return result;
		} catch (NullPointerException e) {
	...
	public static Object invokeGetter(Object obj, String property) {
		if (obj instanceof Map) {
			...
			return BeanPropertyUtils.getProperty(obj, property);
		}
	}
	...
	public static boolean invokeSetter(Object target, String property, Object value, boolean autoConvert, boolean ingoreNullValue) {
		...
		if (autoConvert) {
			Class type = BeanPropertyUtils.getPropertyType(target.getClass(), property);
		...
		if (!ingoreNullValue || newValue != null) {
			BeanPropertyUtils.setProperty(target, property, newValue);
		}
		return true;
	}
	...
	private static String[] getPropertyNames(Object obj) {
		...
		String[] result = BeanPropertyUtils.getPropertyNames(obj.getClass());
