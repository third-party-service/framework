package com.jzg.framework.utils.date;
...
/*public final class DateUtils {
    ...
    *//**
     * 字符串转化为时间
     * @param strDate   时间字符串
     * @param pattern  转化格式  默认使用yyyy-MM-dd HH:mm:ss
     * @return
     * @throws ParseException
     *//*
    ...
    *//**
     * CST格式时间转化为标准格式字符串
     * 例如：Tue Mar 01 00:00:00 CST 2016
     * formarts.add("E MMM dd hh:mm:ss z yyyy");
     * @param dateStr
     * @return
     *//*
    public static String parseCtsDateToString(String dateStr) {
        String newStr = null;
        try {
            Date d = new Date(dateStr);
            DateFormat dateFormat = new SimpleDateFormat(DEFAULT_DATETIME_PATTERN);
            newStr = dateFormat.format(d);
        } catch (Exception e) {
